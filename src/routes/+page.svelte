<script lang="ts">
    ...
    let selectedVillage = data.villages[0];
...
<section id="page">
    <div class="mapPanel">
        ...
        <section class="mapContainer">
            <Map villages={data.villages} on:villageHover={handleVillageHover} />
        </section>
    </div>
...
<style lang="scss">
    ...
    .mapPanel {
        ...
        display: grid;
        grid-template-columns: minmax(350px, 400px) minmax(200px, 800px);
        gap: 5rem;
    }
</style>
